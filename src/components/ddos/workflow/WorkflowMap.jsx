      ...
      >
        ...
        {packetPos && (
          <g>
            ...
            />
            <circle cx={packetPos.x} cy={packetPos.y} r={3.5} fill="#ef4444" />
          </g>
        )}
      </svg>
            ...
            >
              <div
                ...
                className={[
                  ...
                  "bg-black/70 text-white shadow-[0_0_18px_rgba(239,68,68,0.12)]",
                  isActive
                    ...
                    >
                      <div className="rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-2.5">
                        <div className="flex items-center justify-between">
                          <p className="font-mono text-[8.5px] uppercase tracking-[0.18em] text-red-300">
                            On arrival
                          </p>
                          <span className="rounded-md bg-red-500/15 p-1 text-red-200">
                            <EventIcon size={12} />
                          </span>
                        </div>
                        <p className="mt-1 text-[11px] leading-relaxed text-red-100">
                          {item.stage.status}
                        </p>
                        <p className="mt-1 font-mono text-[9.5px] leading-relaxed text-red-200/80 break-all">
                          {item.stage.request}
                        </p>
                      </div>
                    </motion.div>
